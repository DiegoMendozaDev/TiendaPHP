...
-- Tiempo de generación: 13-02-2025 a las 15:37:45
...
CREATE TABLE `usuarios` (
  ...
  `fecha_registor` timestamp NOT NULL DEFAULT current_timestamp(),
...
--
ALTER TABLE `pedidos`
  ADD CONSTRAINT `fk_usuairo_pedido` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`);
