...
<head>
  ...
  <link href="http://localhost/Proyecto_tienda_PHP/client/public/assets/css/product.css" rel="stylesheet">
</head>
  ...
  <main>
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-body-tertiary">
      <div class="col-md-6 p-lg-5 mx-auto my-5">
        <h1 class="display-3 fw-bold">Estilo urbano, lujo al alcance.</h1>
        <h3 class="fw-normal text-muted mb-3">Combina la sensación de lujo y comodidad, enfatizando la calidad sin sacrificar la accesibilidad.</h3>
    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
      <div class="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        <div class="my-3 py-3">
          <h2 class="display-5"><?= $productos[0]->nombre ?></h2>
      ...
      <div class="bg-body-tertiary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        <div class="my-3 p-3">
          <h2 class="display-5"><?= $productos[2]->nombre ?></h2>
          <p class="lead"><?= $productos[2]->descripcion ?></p>
        </div>
        <div class="bg-dark shadow-sm mx-auto" style="border-radius: 21px 21px 0 0;">
          <img src=<?= $productos[2]->foto ?> class="img-fluid">  
        </div>
      </div>
    </div>
    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
      <div class="bg-body-tertiary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        <div class="my-3 p-3">
          <h2 class="display-5"><?= $productos[1]->nombre ?></h2>
          <p class="lead"><?= $productos[1]->descripcion ?></p>
        </div>
        <div class="bg-dark shadow-sm mx-auto" style="border-radius: 21px 21px 0 0;">
          <img src=<?= $productos[1]->foto ?> class="img-fluid">  
        </div>
      </div>
