...
<head>
  ...
  <link href="http://localhost/Proyecto_tienda_PHP/client/public/assets/css/features.css" rel="stylesheet">
</head>
            ...
            <div class="col">
              <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('<?=$producto->foto?>');">
                <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                  <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold"><?= $producto->nombre?></h3>
